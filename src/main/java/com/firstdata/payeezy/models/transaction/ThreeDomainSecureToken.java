...
public class ThreeDomainSecureToken extends Card {
    ...
    @JsonProperty("type")
    private String threeDomainType;
    /*
    ...
    public String getThreeDomainType() {
        return this.threeDomainType;
    }
    
    
   public void setThreeDomainType(String type) {
        this.threeDomainType = type;
    }
